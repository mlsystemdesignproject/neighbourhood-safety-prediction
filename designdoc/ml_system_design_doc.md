...
**Цель фазы.** Исследование бизнес задачи и выбор: 
...
#### 3.2.7 Перевод из оценки числа преступлений в уровень безопасности
> Как осуществить перенос числа преступлений в районах города в уровень безопасности.

#### 3.2.8 Выбор способа реализации Baseline модели
> описать выбор ключевых инструментов

#### 3.2.9 Реализация Baseline модели
