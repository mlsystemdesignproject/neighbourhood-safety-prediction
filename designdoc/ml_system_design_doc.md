...
##### 2.3.1 Milestone 1. Первичное знакомство с задачей/данными и пробный (natural) сервис 
...
Цель проекта: предоставление прогноза о безопасности районов Лондона.

Естественное предположение - это сделать прогноз возможных преступлений в каждом районе города.
 
> Заказчиком заявлено требование предоставление данной информации на 6 месяцев. Но в формулировке отсутствует временные требования, так как они зависят от многих дополнительных факторов. Формулировка будет уточняться в процессе с знакомством возможных источников данных.

> Подходы и ключевые идеи заносятся в документ assumptions.md
###### 2.3.1.2 Первичные поиск источников данных 
Для нашего проекта выбраны данные о ежедневной преступности в районах Лондона, данные от MPS.
Отметим, что данные поступают с задежкой в 1.5 - 2 месяца. Данная задержка приводит к требованию горизонта планирования от 60 и более дней. 
...
###### 2.3.1.3 Формулирование идеи и предположений для этапа исследование 
...
Надо выбрать/ограничить рассматриваемое число деяний, в зависимости от бизнес запроса.  

> Идеи и предположения заносятся в документ assumptions.md
###### 2.3.1.4 Выбор датасета и natural варианта решения задачи
В качестве данных будет выбран датасет от MPS о ежедневной преступности в районах Лондона.
В качестве задачи - задача регрессии для временных рядов.
Выбор метрики для модели (уточнения от Оксаны).

###### 2.3.1.5 Проведение первичного EDA 
Исследование датасета и распределения преступлений. 
...
**Цель эпохи.** Исследование бизнес задачи и выбор: 
...
Поиск данных для гипотез из файла assumptions и рассмотрение возможных источников:
- актуальных данных о районах и деяниях в Лондоне,
...
##### 2.3.2.4 Выбор ключевых метрик

##### 2.3.2.5 EDA новых моделей и данных
##### 2.3.2.6 Описать процесс обновления модели
...
Исследования: 
- Какие регулярные социальные явления могут быть интересны (см. assumptions_xx.md)
- 
