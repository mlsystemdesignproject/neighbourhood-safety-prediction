...
> Для описания того, как шло развитие проекта во времени
...
##### 2.3.1.4 Выбор датасета и естественный(natural) варианта решения задачи
...
Выбор регулярных событий социальных событий, которые могу влиять на число преступлений в одном из районов Лондона в этот день:
- футбольные матчи на крупных стадионах,
- концерты собирающие более 10'000 человек,
