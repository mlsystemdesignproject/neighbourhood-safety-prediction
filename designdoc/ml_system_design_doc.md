...
## 3. Ключевые фазы (временные периоды) разработки решения задачи 
...
### 3.3 Совершенствование модели и реализация MVP сервиса

**Цель фазы.** Реализация:
- пайплайнов данных и моделей согласно M2,
- сервисной части проекта,
- мониторинга работы модели.  
- оформляется документация,
- MLE - улучшают модель,
- MLops/DE - готовит docker, kubernetes + выкладывает модель в Yandex Cloud
